...
const styles = tv({
  base: "group bg-surface-container border border-surface-outline text-surface-on text-sm rounded-lg drop-shadow-lg will-change-transform px-3 py-1",
  variants: {
    isEntering: {
    ...
    >
      <OverlayArrow>
        <svg
          ...
          height={8}
          viewBox="0 0 8 8"
          className="fill-surface-container-high stroke-surface-outline group-placement-left:-rotate-90 group-placement-right:rotate-90 group-placement-bottom:rotate-180 forced-colors:fill-[Canvas] forced-colors:stroke-[ButtonBorder]"
        >
