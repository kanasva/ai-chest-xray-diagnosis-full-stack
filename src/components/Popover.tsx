...
const styles = tv({
  base: "bg-surface-container-high dark:bg-zinc-900/70 dark:backdrop-blur-0 forced-colors:bg-[Canvas] shadow-2xl rounded-xl bg-clip-padding border border-black/10 dark:border-white/[15%] text-slate-700 dark:text-zinc-300",
  variants: {
    isEntering: {
