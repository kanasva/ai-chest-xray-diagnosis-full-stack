...
import { composeTailwindRenderProps, focusRing } from "./react-aria";
  ...
  return (
    <AriaListBox
      ...
      className={composeTailwindRenderProps(
        props.className,
        "ounded-lg border border-gray-300 p-1 outline-0 dark:border-zinc-600",
      )}
    >
      {children}
    </AriaListBox>
...
export const dropdownItemStyles = tv({
  ...
  variants: {
    ...
    isFocused: {
      true: "bg-surface-container-high-hovered cursor-pointer forced-colors:bg-[Highlight] forced-colors:text-[HighlightText]",
    },
  },
  compoundVariants: [
    {
